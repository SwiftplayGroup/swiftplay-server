...
async function addToAuditLog(eventName: "gamePages.categories.create" | "gamePages.create" | "gamePages.delete" | "gamePages.edit", actorID: ObjectId, targetID: ObjectId, sessionID: ObjectId) {
